...
$.when(counties).done(function (doto) {
	...
	function onEachFeature(feature, layer) {
		...
		const { shop, shopCode, adress, url, nom, region, shops } = feature.properties;
...
submitBtn.addEventListener("click", (e) => {
	...
	L.geoJSON(counties.responseJSON, {
		...
		onEachFeature: function (feature, layer) {
			console.log(layer.leaflet_id);
			feature.geometry.type === "Polygon" || feature.geometry.type === "MultiPolygon"  ? console.log(feature) : ""
			feature.properties.nom === "Corse" ? console.log(layer) : ""
		}
	})
});
